programa
{
    ...
    funcao inteiro calcularDanoAtaque(inteiro ataque, inteiro critico)
    {
        se(critico == 5)
        {
            retorne ataque * 2
    ...
    funcao inteiro calcularDanoDefesa(inteiro ataqueInimigo, inteiro defesa)
    {
        inteiro dano = ataqueInimigo - defesa
    ...
    funcao inteiro curarVida(inteiro vida, inteiro cura)
    {
        vida = vida + cura
                    ...
                    enquanto(vida > 0 e vidaMonstro > 0 e fugiu == 0)
                    {
                        ...
                        escolha(acao)
                        {
                            caso 1:
                                ...
                                se(critico == 5)
                                {
                                    vidaMonstro = vidaMonstro - calcularDanoAtaque(ataque, critico)
                                    escreva("\n*** GOLPE CRITICO! ***\n")
                            ...
                            caso 2:
                                ...
                                dano = calcularDanoDefesa(atkE[fase], defesa)
                            ...
                            caso 4:
                                ...
                                se(energia >= custoPoder[sp])
                                {
                                    ...
                                    senao se(sp == 4)
                                    {
                                        vida = curarVida(vida, curaPoder[sp])
            ...
            enquanto(vida > 0 e vidaChefe > 0)
            {
                ...
                escolha(acao)
                {
                    caso 1:
                        ...
                        se(critico == 5)
                        {
                            vidaChefe = vidaChefe - calcularDanoAtaque(ataque, critico)
                            escreva("\n*** GOLPE CRITICO! ***\n")
                            escreva("Voce causou ", ataque * 2, " de dano!\n")
                        }
                        senao
                    ...
                    caso 2:
                        ...
                        dano = calcularDanoDefesa(atkChefe, defesa)
                    ...
                    caso 4:
                        ...
                        se(energia >= custoPoder[sp])
                        {
                            ...
                            senao se(sp == 4)
                            {
                                vida = curarVida(vida, 60)
                                escreva("\n*** REGENERACAO! ***\n")
                                escreva("Voce recuperou 60 de vida!\n")
                            }
                            senao se(sp == 8)
                            {
                                vida = curarVida(vida, 40)
                                invis = 1
                                escreva("\n*** INVISIBILIDADE! ***\n")
